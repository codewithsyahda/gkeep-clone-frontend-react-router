...
test.describe(() => {
  ...
  test.describe('Trashes After Searching Notes', () => {
    ...
    [
      ...
      ({
        ...
        test(`should trash ${otherSelection.length + 1} searched selected ${otherSelection.length ? 'notes' : 'note'}`, async ({
          page,
          tapOrClick,
          activeNotesPageFxt,
          trashNotesPageFxt,
    ...
    [
      ...
      test(`should undo after trashing ${otherSelection.length + 1} searched selected ${otherSelection.length ? 'notes' : 'note'}`, async ({
        page,
        tapOrClick,
        activeNotesPageFxt,
        trashNotesPageFxt,
  ...
  test('should trash selected active notes', async ({
    page,
    tapOrClick,
    activeNotesPageFxt,
    trashNotesPageFxt,
  ...
  test('should undo after trashing selected active notes', async ({
    page,
    tapOrClick,
    activeNotesPageFxt,
    trashNotesPageFxt,
  ...
  test('should trash selected archived notes', async ({
    page,
    tapOrClick,
    activeNotesPageFxt,
    archiveNotesPageFxt,
  ...
  test('should undo after trashing selected archived notes', async ({
    page,
    tapOrClick,
    activeNotesPageFxt,
    archiveNotesPageFxt,
