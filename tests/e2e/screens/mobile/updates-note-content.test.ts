...
test.describe(() => {
  ...
  test.describe('Updates Note Content After Archiving Note Via Note Detail Dialog', () => {
  ...
  test.describe('Updates Note Content After Unarchive Note Via Note Detail Dialog', () => {
...
test.describe('Updates Note Content After Searching Notes', () => {
  ...
  test.describe('Updates Note Content After Archiving Note Via Note Detail Dialog', () => {
    test('should update an archived note content', async ({
      ...
      await activeNotesPageFxt.appTopBar
        .getSearchInput()
        .fill('updated Note title 6');
