...
test.describe(() => {
  ...
  test.describe('Archives Note After Searching Notes', () => {
    ...
    [
      ...
      [
        ...
        test(`should undo after archiving ${otherSelection.length + 1} searched selected ${otherSelection.length ? 'notes' : 'note'} with ${subsequentSelect} subsequent select`, async ({
          page,
          tapOrClick,
          activeNotesPageFxt,
          archiveNotesPageFxt,
  ...
  [
    ...
    test(`should undo after archiving selected active notes with ${subsequentSelect} subsequent select`, async ({
      page,
      tapOrClick,
      activeNotesPageFxt,
      archiveNotesPageFxt,
